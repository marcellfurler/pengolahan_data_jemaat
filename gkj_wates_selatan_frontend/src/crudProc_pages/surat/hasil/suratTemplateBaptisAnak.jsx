...
const SuratTemplateBaptisAnak = () => {
  ...
  // ✅ Tombol Print (gunakan fungsi global dari utils)
  const handlePrint = () => {
    printSurat(
      "surat-baptis-anak",
      `Surat-Permohonan-Baptis-Anak_${data.namaAnak || "TanpaNama"}`
    );
  };
      ...
      >
        ...
        >
          ...
          <table style={{ width: "100%", marginTop: "10px" }}>
            <tbody>
              <tr>
                <td style={{ width: "35%" }}>Nama Anak</td>
                <td>: {data.namaAnak || "................................................"}</td>
              </tr>
              <tr>
                <td>Jenis Kelamin</td>
